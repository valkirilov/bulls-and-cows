...
angular.module("myApp.services.auth", []).factory("AuthService", function(a, b, c, d, e, f, g) {
    function h(a) {
        switch (a.provider) {
          case "password":
...
}), angular.module("myApp.services.game", []).factory("GameService", function(a, b, c, d, e, f, g) {
