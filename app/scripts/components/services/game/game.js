...
.factory('GameService', ['$rootScope', '$http', 'ipCookie', '$firebaseObject', '$firebaseArray', '$location', 'AuthService', function ($rootScope, $http, ipCookie, $firebaseObject, $firebaseArray, $location, AuthService) {
