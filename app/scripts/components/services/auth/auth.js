...
.factory('AuthService', ['$http', 'ipCookie', '$firebaseAuth', '$firebaseArray', '$firebaseObject', '$location', '$rootScope', function ($http, ipCookie, $firebaseAuth, $firebaseArray, $firebaseObject, $location, $rootScope) {
